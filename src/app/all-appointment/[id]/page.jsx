...
const DoctorDetailsPage = async ({ params }) => {
    ...
    return (
        <div>
            <div className="mt-10 xl:flex lg:max-w-7/12 mx-auto gap-10 hover:translate-y-1 transition duration-300 lg:m-20 items-center">
                <Image src={data.image} alt={data.name} width={500} height={500} className='w-80 h-80 lg:w-130 lg:h-150 rounded-2xl shadow-2xl shadow-green-200'></Image>
